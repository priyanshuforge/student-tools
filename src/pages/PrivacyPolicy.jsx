          ...
          <div className="card shadow-sm">
            <div className="card-body p-5">
              ...
              <p>
                ...
                account or provide personal information to use our calculators.
              </p>

              <h3 className="mt-4">Calculator Data</h3>
              <p>
                Values entered into our CGPA and Attendance calculators are used
                only to perform calculations and are not permanently stored by
                StudentTools.
              </p>
              ...
              <p>
                ...
                use of information will be governed by their respective privacy
                policies.
              </p>

              <h3 className="mt-4">Changes to This Policy</h3>
              <p>
                This Privacy Policy may be updated as StudentTools develops and
