        ...
        <div className="col-lg-8">
          <div className="card shadow-sm">
            <div className="card-body p-4 p-md-5">
              ...
              <p>
                StudentTools is a free online platform designed to make everyday
                academic calculations simple and quick for students.
              </p>
              ...
              <p>
                StudentTools currently provides a CGPA to Percentage Calculator
                and an Attendance Calculator. More useful academic tools will be
                added over time.
              </p>
              ...
              <p>
                ...
                universities and institutions. Results provided by StudentTools
                are for informational purposes. Students should verify official
